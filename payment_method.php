...
<body>
    ...
    <a href="khalti_payment.php?product_id=<?= $product_id ?>&size=<?= urlencode($size) ?>&quantity=<?= $quantity ?>" class="btn">Pay with Khalti</a>
    <a href="shipping_details.php?product_id=<?= $product_id ?>&size=<?= urlencode($size) ?>&quantity=<?= $quantity ?>" class="btn">Cash on Delivery</a>
